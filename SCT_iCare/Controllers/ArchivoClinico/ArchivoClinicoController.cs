...
namespace SCT_iCare.Controllers.ArchivoClinico
{
    public class ArchivoClinicoController : Controller
    {
        ...
        public ActionResult Guardar_Odontologia(int id, string exploracion, string nota,
            string NDiente_18, string ret_Diente_18, string obt_Diente_18, string NDiente_17, string ret_Diente_17, string obt_Diente_17, string NDiente_16, string ret_Diente_16, string obt_Diente_16, string NDiente_15, string ret_Diente_15, string obt_Diente_15,
            string NDiente_14, string ret_Diente_14, string obt_Diente_14, string NDiente_13, string ret_Diente_13, string obt_Diente_13, string NDiente_12, string ret_Diente_12, string obt_Diente_12, string NDiente_11, string ret_Diente_11, string obt_Diente_11,
            string NDiente_28, string ret_Diente_28, string obt_Diente_28, string NDiente_27, string ret_Diente_27, string obt_Diente_27, string NDiente_26, string ret_Diente_26, string obt_Diente_26, string NDiente_25, string ret_Diente_25, string obt_Diente_25,
            string NDiente_24, string ret_Diente_24, string obt_Diente_24, string NDiente_23, string ret_Diente_23, string obt_Diente_23, string NDiente_22, string ret_Diente_22, string obt_Diente_22, string NDiente_21, string ret_Diente_21, string obt_Diente_21,
            string NDiente_48, string ret_Diente_48, string obt_Diente_48, string NDiente_47, string ret_Diente_47, string obt_Diente_47, string NDiente_46, string ret_Diente_46, string obt_Diente_46, string NDiente_45, string ret_Diente_45, string obt_Diente_45,
            string NDiente_44, string ret_Diente_44, string obt_Diente_44, string NDiente_43, string ret_Diente_43, string obt_Diente_43, string NDiente_42, string ret_Diente_42, string obt_Diente_42, string NDiente_41, string ret_Diente_41, string obt_Diente_41,
            string NDiente_38, string ret_Diente_38, string obt_Diente_38, string NDiente_37, string ret_Diente_37, string obt_Diente_37, string NDiente_36, string ret_Diente_36, string obt_Diente_36, string NDiente_35, string ret_Diente_35, string obt_Diente_35,
            string NDiente_34, string ret_Diente_34, string obt_Diente_34, string NDiente_33, string ret_Diente_33, string obt_Diente_33, string NDiente_32, string ret_Diente_32, string obt_Diente_32, string NDiente_31, string ret_Diente_31, string obt_Diente_31)
        {
